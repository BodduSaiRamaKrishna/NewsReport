...
<a href="adminpage.jsp" class="navbar-brand">Home</a> &nbsp;&nbsp;
  ...
  <a class="align-right" href="viewclients.jsp">User Logins</a>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
                       <center> <h2><b>Client Management</b></h2></center>
                    </div>
            ...
            <table class="table table-striped table-hover">
                <thead>
                	...
                	ResultSet rs=con.createStatement().executeQuery("select * from registers");
                	while(rs.next())
                	{
                	%>
                	<tr>
